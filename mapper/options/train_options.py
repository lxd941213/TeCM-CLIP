...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--change_type', default='HairStyle', type=str, help='Which mapper to use')
		...
		self.parser.add_argument('--clip_lambda', default=0.6, type=float, help='CLIP loss multiplier factor')
		self.parser.add_argument('--latent_l2_lambda', default=1.0, type=float, help='Latent L2 loss multiplier factor')
		self.parser.add_argument('--face_l2_lambda', default=0.0, type=float, help='face L2 loss multiplier factor')
		self.parser.add_argument('--bg_l2_lambda', default=0.0, type=float, help='background L2 loss multiplier factor')
		...
		self.parser.add_argument('--image_interval', default=200, type=int, help='Interval for logging train images during training')
		...
		self.parser.add_argument('--description', default=None, type=str, help='Driving text prompt')
